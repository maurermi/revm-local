...
## [0.1.0](https://github.com/maurermi/revm-local/releases/tag/revm-test-v0.1.0) - 2025-01-25
...
- *(deps)* bump alloy-sol-macro from 0.7.6 to 0.7.7 (#1613)
- release (#1579)
- release (#1548)
- replace TransactTo with TxKind (#1542)
- *(deps)* bump regex from 1.10.4 to 1.10.5 (#1502)
- release (#1261)
...
- chore(Test) : const to static ([#1016](https://github.com/maurermi/revm-local/pull/1016))
- Burntpix criterion bench ([#1004](https://github.com/maurermi/revm-local/pull/1004))
- Instruction table ([#759](https://github.com/maurermi/revm-local/pull/759))
- rewrite revm-test as a criterion bench (#579)
- optimize stack usage for recursive `call` and `create` programs ([#522](https://github.com/maurermi/revm-local/pull/522))
- Bump v24, revm v3.3.0 ([#476](https://github.com/maurermi/revm-local/pull/476))
- Release v23, revm v3.2.0 ([#464](https://github.com/maurermi/revm-local/pull/464))
- Release v22, revm v3.1.1 ([#460](https://github.com/maurermi/revm-local/pull/460))
- v21, revm v3.1.0 (#444)
- remove gas blocks (#391)
- *(deps)* bump bytes from 1.3.0 to 1.4.0 (#355)
- Bump v20, changelog ([#350](https://github.com/maurermi/revm-local/pull/350))
- includes to libs (#338)
- Creating revm-primitives, revm better errors and db components  ([#334](https://github.com/maurermi/revm-local/pull/334))
- Cleanup, move hot fields toggether in Interpreter ([#321](https://github.com/maurermi/revm-local/pull/321))
- native bits ([#278](https://github.com/maurermi/revm-local/pull/278))
- *(release)* Bump revm and precompiles versions
- Bump primitive_types. Add statetest spec
- Bump revm v2.1.0 ([#224](https://github.com/maurermi/revm-local/pull/224))
- revm bump v2.0.0, precompile bump v1.1.1 ([#212](https://github.com/maurermi/revm-local/pull/212))
- Cfg choose create analysis, option on bytecode size limit ([#210](https://github.com/maurermi/revm-local/pull/210))
- Cargo sort. Bump lib versions ([#208](https://github.com/maurermi/revm-local/pull/208))
- Return `ExecutionResult`, which includes `gas_refunded` (#169)
- Bytecode hash, remove override_spec, ([#165](https://github.com/maurermi/revm-local/pull/165))
- revm bump 1.8. update libs. snailtracer rename ([#159](https://github.com/maurermi/revm-local/pull/159))
- v6 changelog, bump versions
- Big Refactor. Machine to Interpreter. refactor instructions. call/create struct ([#52](https://github.com/maurermi/revm-local/pull/52))
- [revm] pop_top and unsafe comments ([#51](https://github.com/maurermi/revm-local/pull/51))
